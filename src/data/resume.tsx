...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/kapilansh-10",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/kapilansh-p-1a3b92157/",
        icon: Icons.linkedin,
        navbar: true,
      },
      X: {
        name: "X",
        url: "https://x.com/kapilansh_twt",
        icon: Icons.x,
        navbar: true,
      },
      email: {
        name: "kapilpatil2004@gmail.com",
        url: "#",
        icon: Icons.email,
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Anonify is an anonymous messaging app where anyone can send you a message through a shareable link — no login needed — while you manage everything privately in your dashboard (view, delete, filter, and moderate messages).",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
